         ...
         dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75'
            ...
            <nav className='flex fixed top-[0.15rem] left-1/2 h-12 
                ...
                <ul className='flex w-[22rem] flex-wrap 
                    ...
                    {links.map(link => (
                        <motion.li className='h-3/4 flex 
                            ...
                            >
                                {link.name}
                                {
                                    link.name == activeSection && (<motion.span className='bg-gray-100 rounded-full 
                                    absolute inset-0 -z-10 dark:bg-gray-800 dark:text-gray-200'
